...
const HalamanSignup = () => {
    ...
    return(
      <div className="Signup w-screen h-full flex flex-col min-h-screen justify-center items-center bg-gradient-to-br from-blue to-orange">
        ...
        <div action="" method="POST" className=' w-[80%] p-8 flex flex-col mb-8 justify-center items-center bg-white border border-dark-gray rounded-lg lg:w-2/5 lg:p-16 lg:mb-0'>
          <div className="title font-bold text-2xl mb-2 lg:text-3xl">Signup to take test</div>
          <div className='text-xs text-dark-gray mb-8 lg:text-sm'>It is recommended that you be over 17 years of age to register</div>
          <div className=' text-xs mb-8 text-red border border-red w-full h-10 hidden items-center justify-center rounded-md bg-light-red/25 ' id='errorMessage'></div>
          <div className="content flex flex-col w-full mb-8 lg:flex-row">
            <div className="left w-full mr-16 lg:w-1/2">
              ...
              <Input placeholder={"Enter your username"} value={username} type={"input"} id={"username"} onChange={(e) => setUsername(e.target.value)}>Username</Input>
              ...
              <Input placeholder={"Enter your password again"} value={confirm_password} type={"password"} id={"confirm-password"} onChange={(e) => setConfirmPassword(e.target.value)}>Confirm Password</Input>
            </div>
            <div className="right w-full lg:w-1/2">
              <div className="radioInput flex flex-col justify-center items-center mb-4">  
                <label htmlFor="" className=" w-full text-sm text-left text-dark-gray mb-2 lg:text-md">Gender</label>
